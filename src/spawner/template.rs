...
//         spawn_points: &[Point]
//     ){
//         let mut availabile_entities = Vec::new();
//         self.entities
//             .iter()
//             .filter(|e| e.levels.contains(&level))
//             .for_each(|t| {
//                 for _ in 0 .. t.frequency {
//                     availabile_entities.push(t);
//                 }
//             });
//         let mut commands = CommandBuffer::new(ecs);
//         spawn_points.iter().for_each(|pt| {
//             if let Some(entity) = rng.random_slice_entry(&availabile_entities) {
