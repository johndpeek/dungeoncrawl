...
impl State {
    fn new() -> Self {
        ...
        // spawn_amulet_of_power(&mut ecs, map_builder.amulet_start);
    ...
    fn game_over(&mut self, ctx: &mut BTerm) {
        ...
        ctx.print_color_centered(4, WHITE, BLACK, "Slain by a monster, your hero's journey has come to an end");
        ctx.print_color_centered(5, WHITE, BLACK, "Your home town is lost");
        ctx.print_color_centered(8, YELLOW, BLACK, "Try again");
    ...
    fn reset_game_state(&mut self){
        ...
        //spawn_amulet_of_power(&mut self.ecs, map_builder.amulet_start);
        let exit_idx = map_builder.map.point2d_to_index(map_builder.amulet_start);
        map_builder.map.tiles[exit_idx] = TileType::Exit;
        // map_builder.map.tiles
